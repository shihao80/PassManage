...
// 子表 排序相关
    var CONFIG = {
        tableNameRest:"p_pass_instant_rest",
        tableName:"p_pass_instant",
        moduleName:"p_pass_instant",//sys_module的moduleName
        form:{
                passExpiry:{
        ...
        //排序跟数据库实际字段名的映射
        sortMap:{
            passId:'pass_id',passName:'pass_name',passLength:'pass_length',passType:'pass_type',passExpiry:'pass_expiry',passUserid:'pass_userid'
        }
    };
    //后端请求时候的表模块规则url
