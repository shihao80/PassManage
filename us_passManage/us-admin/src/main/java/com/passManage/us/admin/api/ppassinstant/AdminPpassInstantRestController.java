package com.passManage.us.admin.api.ppassinstant;
...
@RequestMapping("/admin/p_pass_instant_rest/")
@RestController
public class AdminPpassInstantRestController extends CommonRestController<PpassInstant,Integer> implements InitializingBean
{
    ...
    public ResponseMsg page(
        ...
        Integer count = ppassInstantService.getModelListCount(query);
        ...
        if(queryType==null || queryType == QUERY_TYPE_SEARCH){//普通查询
            ...
            return new ResponseMsg(count,ppassInstantService.getModelList(query));
        }else if(queryType == QUERY_TYPE_EXPORT_EXCEL){
            query.put("start",(page - 1) * limit);query.put("limit",limit);
            exportExcel(response,ppassInstantService.getModelList(query),"p_pass_instant",
    ...
    public void afterPropertiesSet() throws Exception {
        super.commonService = ppassInstantService;
     ...
     * @return
     */
    @RequestMapping(value = "/updateKeyAlert",method = RequestMethod.GET)
    public ResponseMsg updateKeyAlert(@RequestParam("id")String id){
        String updateMsg = ppassInstantService.updateKeyAlert(id);
        return new ResponseMsg(200,updateMsg);
    }
}
