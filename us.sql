...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`us` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
insert  into `sys_global_permit_url`(`id`,`permit_name`,`backend_url_reg`,`module_id`) values (2,'允许进入后台,使用有些通用接口（请勿删除）','/admin/(rmp|page|page_v2|common_file_rest).*',NULL),(3,'通用获取权限相关接口（请勿删除）','/admin/rest_rmp/(get_permission_list|get_module_list|user_info).*',NULL);
...
insert  into `sys_module`(`id`,`module_name`,`module_url`,`module_category_id`,`sort_num`,`module_title`,`if_show`) values (1,'goods','admin/page_v2/goods/list',1,1,'商品管理',1),(2,'goods_category','admin/page_v2/goods_category/list',1,2,'商品类别',1),(4,'sys_log_admin_operate','admin/page_v2/sys_log_admin_operate/list',3,7,'系统日志',1),(5,'sys_module_category','admin/page_v2/sys_module_category/list',3,1,'菜单管理',1),(7,'sys_admin_user','admin/page_v2/sys_admin_user/list',3,3,'管理员',1),(8,'sys_global_permit_url','admin/page_v2/sys_global_permit_url/list',3,6,'全局地址过滤',1),(11,'sys_role','admin/page_v2/sys_role/list',3,2,'角色管理',1),(14,'all_type','admin/page_v2/all_type/list',1,3,'全类型测试',0),(17,'sys','',3,-1,'系统表权限载体（请勿删除）',0),(18,'goods_img','admin/page_v2/goods_img/list',1,4,'商品图集',1),(19,'goods_file','admin/page_v2/goods_file/list',1,5,'商品附件',1),(20,'dict','admin/page_v2/dict/list',3,10,'字典配置',1);
