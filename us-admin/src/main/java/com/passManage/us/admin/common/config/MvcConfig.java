...
import com.passManage.us.admin.common.interceptor.AdminInterceptor;
import com.passManage.us.admin.rmp.common.interceptor.AdminLogOperateInterceptor;
...
public class MvcConfig extends WebMvcConfigurerAdapter {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        // 注册监控拦截器
        registry.addInterceptor(adminInterceptor).addPathPatterns(PermissionConstant.ADMIN_PREFIX+"**").excludePathPatterns(PermissionConstant.STATIC_PREFIX+"**");
        registry.addInterceptor(adminLogOperateInterceptor).addPathPatterns(PermissionConstant.ADMIN_PREFIX+"**").excludePathPatterns(PermissionConstant.STATIC_PREFIX+"**");
    }
