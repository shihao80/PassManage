...
@MapperScan(basePackages =
        {"com.passManage.us.admin.**.mapper"
        ,"com.passManage.us.admin.rmp.**.mapper" // 如果您觉得日志有warn mapper已经存在 比较碍眼 可以注释本行
        ,"com.passManage.us.service.**.mapper"
        }
...
public class DataSourceConfig {
    ...
    private static final String TYPE_ALIASES_PACKAGE =
            ...
            "com.passManage.us.admin.rmp.model," +
            "com.passManage.us.model";//逗号分隔多个
