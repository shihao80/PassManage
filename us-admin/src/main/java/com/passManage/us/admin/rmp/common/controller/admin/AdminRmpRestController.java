...
import com.passManage.us.admin.rmp.common.controller.admin.res.ModuleRes;
import com.passManage.us.admin.rmp.common.controller.admin.res.RmpTreeRes;
...
public class AdminRmpRestController {
    ...
    public ResponseMsg currentUserInfo(){
        return new ResponseMsg(AdminUtil.getAdmin());
    }
