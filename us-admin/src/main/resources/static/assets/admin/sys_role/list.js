...
// 子表 排序相关
    var CONFIG = {
        ...
        childrenPage:[//子页面的一些基础信息 更多信息
            {
                tabTitle:"管理员",
                url:"admin/page_v2/sys_admin_user/list",
    ...
    var COLS = [[
        {type: "checkbox", /*fixed:"left",*/ width:50},//全选
            ...
            {field: 'roleName', title: '角色名', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ mc_util.escapeHTML(d.roleName) +'" class="magicalcoder-table-text layui-input security_list_table_form_roleName" name="roleName" data-identify="'+d.id+'" lay-verify="magicalCoderVerify|mc_required" magicalcoder-verify=""  placeholder="请输入角色名"/>'
                }
                , sort:true
            },
                    ...
                    table.on('tool('+layFilter+')', function(obj){//操作条事件写法 参考layui
                        ...
                        if(layEvent === 'edit'){ //编辑
                            ...
                            layui.layer.open({
                                ...
                                maxmin: true,
                                area: ['80%', '80%'],
                                content : "admin/page_v2/sys_role/permission?roleId="+identify
                                ,btn:["保存"]
