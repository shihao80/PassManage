...
// 子表 排序相关
    var CONFIG = {
        tableNameRest:"p_pass_old_rest",
        tableName:"p_pass_old",
        moduleName:"p_pass_old",//sys_module的moduleName
        form:{
                passExpiry:{
        ...
        //排序跟数据库实际字段名的映射
        sortMap:{
            passId:'pass_id',passName:'pass_name',passLength:'pass_length',passType:'pass_type',passExpiry:'pass_expiry',passCreatetime:'pass_createtime',passUserid:'pass_userid'
        }
    };
    //后端请求时候的表模块规则url
    ...
    var COLS = [[
        {type: "checkbox", /*fixed:"left",*/ width:50},//全选
                {field: 'passId', title: '密钥UUID', minWidth:100, align:"center",sort:true},

            {field: 'passName', title: '密钥名称', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ mc_util.escapeHTML(d.passName) +'" class="magicalcoder-table-text layui-input security_list_table_form_passName" name="passName" data-identify="'+d.passId+'" lay-verify="magicalCoderVerify" magicalcoder-verify="|minLength=0"  placeholder="密钥名称"/>'
                }
                , sort:true
            },

            {field: 'passLength', title: '密钥长度', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ mc_util.escapeHTML(d.passLength) +'" class="magicalcoder-table-text layui-input security_list_table_form_passLength" name="passLength" data-identify="'+d.passId+'" lay-verify="magicalCoderVerify" magicalcoder-verify="|minLength=0"  placeholder="密钥长度"/>'
                }
                , sort:true
            },

            {field: 'passType', title: '密钥类型', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ mc_util.escapeHTML(d.passType) +'" class="magicalcoder-table-text layui-input security_list_table_form_passType" name="passType" data-identify="'+d.passId+'" lay-verify="magicalCoderVerify" magicalcoder-verify="|minLength=0"  placeholder="密钥类型"/>'
                }
                , sort:true
            },
            {field: 'passExpiry', title: '密钥有效期', align:'center', minWidth:250, templet :"#passExpiryTemplate",sort:true},
            {field: 'passCreatetime', title: '密钥上传时间', align:'center', minWidth:250, templet :"#passCreatetimeTemplate",sort:true},

            {field: 'passUserid', title: '密钥使用者', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ mc_util.escapeHTML(d.passUserid) +'" class="magicalcoder-table-text layui-input security_list_table_form_passUserid" name="passUserid" data-identify="'+d.passId+'" lay-verify="magicalCoderVerify" magicalcoder-verify="|minLength=0" disabled="true" placeholder="密钥使用者"/>'
                }
                , sort:true
            },
