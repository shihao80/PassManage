...
;!function() {
    ...
    var authtree = {
        ...
        render: function (dst, trees, opt) {
            ...
            $(dst).html(authtree.renderAuth(trees, 0, {inputname: inputname, layfilter: layfilter, openall: openall}));
            form.render();
        ...
        renderAuth: function (tree, dept, opt) {
            ...
            layui.each(tree, function (index, item) {
                ...
                // 注意：递归调用时，this的环境会改变！
                var append = hasChild ? authtree.renderAuth(item.list, dept + 1, opt) : '';
    ...
    youyaboot_all.authtree = authtree;
